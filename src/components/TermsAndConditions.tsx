  ...
  return (
    <div className="p-4">
      ...
      <p className="text-center text-1xl text-cyan-700">
        ...
        is an app designed to collect and display statistics about home poker
        games. The App uses Google Sign-In to authenticate users and collect
        basic profile information including email, name, and profile image.
        ...
        {"\n"}3.3. You agree to provide accurate and complete information when
        using the App.{"\n"} 4. Privacy and Data Usage 4.1. We respect your
        privacy and are committed to protecting your personal data. Please refer
        to our Privacy Policy for details on how we collect, use, and share your
        information. {"\n"}4.2. By using the App, you consent to the collection
        and use of your information as described in our Privacy Policy.{"\n"} 5.
        User Content {"\n"}5.1. You retain all rights to any content you submit,
        post, or display on or through the App.{"\n"} 5.2. By submitting content
        to the App, you grant Poker Donkey a worldwide, non-exclusive,
        ...
        {"\n"} 6.3. Attempting to gain unauthorized access to the App or its
        related systems.{"\n"} 6.4. Using the App for any illegal or
        unauthorized purpose.{"\n"} 7. Intellectual Property{"\n"} 7.1. The App
        and its original content, features, and functionality are owned by nadav
        galili and are protected by international copyright, trademark, patent,
        trade secret, and other intellectual property laws. {"\n"}8. Disclaimer
        of Warranties{"\n"}8.1. The App is provided on an "as is" and "as
        available" basis without any warranties of any kind.{"\n"} 8.2. We do
        not warrant that the App will be uninterrupted, timely, secure, or
        error-free.{"\n"} 9. Limitation of Liability To the fullest extent
        permitted by applicable law, Poker Donkey shall not be liable for any
        indirect, incidental, special, consequential, or punitive damages
        resulting from your use of the App.{"\n"} 10. Changes to Terms We
        reserve the right to modify or replace these Terms at any time. If a
