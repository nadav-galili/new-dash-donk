    ...
    <div className="p-4">
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        <p>
          ...
          We Use Your Information We use the collected information for various
          purposes, including: - Providing and maintaining the App - Improving
          and personalizing user experience - Analyzing usage of the App -
          Communicating with you - Ensuring the security of the App {"\n"}4.
          Data Storage and Security We implement appropriate technical and
          organizational security measures to protect your information. However,
          please note that no method of transmission over the internet or
          electronic storage is 100% secure.{"\n"} 5. Data Sharing and
          Disclosure We do not sell your personal information. We may share your
          information in the following situations: - With your consent - To
          comply with legal obligations - To protect our rights, privacy,
          safety, or property{"\n"}6. Your Data Protection Rights Depending on
          your location, you may have certain rights regarding your personal
          information, such as: - The right to access - The right to
          rectification - The right to erasure - The right to restrict
          processing - The right to data portability - The right to object{"\n"}{" "}
          7. Children's Privacy The App is not intended for children under 13.
          We do not knowingly collect personal information from children under
          13.{"\n"} 8. Changes to This Privacy Policy We may update our Privacy
          ...
          date.{"\n"} 9. Third-Party Services The App uses Google Sign-In.
          Please refer to Google's Privacy Policy for information on how they
          handle your data. {"\n"}
